      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        ...
        >
          ...
          <motion.div 
            ...
            className="mb-20 transform transition-transform hover:scale-[1.01] duration-500"
          >
      ...
      <section className="py-24 border-t border-white/5 bg-[#0F0F13] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative group perspective-1000">
      ...
      <section className="py-24 border-t border-white/5 bg-[#0A0A0A] relative">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={staggerContainer}
            className="grid lg:grid-cols-2 gap-16 items-center flex-col-reverse lg:flex-row-reverse"
          >
