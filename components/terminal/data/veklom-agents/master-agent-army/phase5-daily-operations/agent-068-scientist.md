...
Research sovereign data transfer for the BYOS runtime: policy-approved encrypted transfers, content-addressed chunks, signed manifests, edge cache with provenance, store-and-forward for offline nodes.
...
# 3. Experiment: implement in scratch/agent-068/
...
All experiments: `scratch/agent-068/`
