...
Research cloud architecture: BYOS runtime placement optimization, Coolify/Cloudflare split, private cloud templates, local model routing (Ollama/vLLM), GPU utilization, autoscaling queues.
...
# 3. Experiment: implement in scratch/agent-069/
...
All experiments: `scratch/agent-069/`
