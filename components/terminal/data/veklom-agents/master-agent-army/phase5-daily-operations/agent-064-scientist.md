...
Research and test latency optimization: provider selection, caching strategies, request batching, model warm-up, connection pooling. Target: reduce median inference latency by 40%.
...
# 3. Experiment: implement in scratch/agent-064/
...
All experiments: `scratch/agent-064/`
