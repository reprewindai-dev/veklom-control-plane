...
Research governance hardening: prompt injection resistance, tool poisoning detection, least-privilege manifests, output schema validation, post-quantum crypto migration paths.
...
# 3. Experiment: implement in scratch/agent-066/
...
All experiments: `scratch/agent-066/`
