...
Verify data integrity: DB consistency, audit log tamper-evidence, tenant isolation, backup/restore, migration safety.
...
```markdown
## Agent-089 Test Run — [Date]
Suite: QA DATA INTEGRITY
Passed: X
Failed: X  
Skipped: X
Coverage: X%
