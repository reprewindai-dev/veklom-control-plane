# Agent-097 — CRAWLER: Market Intelligence
...
Crawl AWS Marketplace, Replicate, Together AI — pricing, vendor counts, features to find vendor leads and market intelligence. Feed qualified leads to vendor hunter agents.
...
Append leads to: `agents/leads/agent-097-leads.csv`
