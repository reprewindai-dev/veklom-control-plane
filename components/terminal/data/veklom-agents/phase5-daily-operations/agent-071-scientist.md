...
Research and improve UACP v5 integration: control plane/data plane separation, VeklomRun execution flow, SEKED governance substrate, decision frame sealing.
...
# 3. Experiment: implement in scratch/agent-071/
...
All experiments: `scratch/agent-071/`
