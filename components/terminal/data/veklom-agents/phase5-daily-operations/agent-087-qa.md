...
Run load tests. Verify p95 latency targets, connection pool limits, system behavior under stress.
...
```markdown
## Agent-087 Test Run — [Date]
Suite: QA PERFORMANCE & LOAD
Passed: X
Failed: X  
Skipped: X
Coverage: X%
