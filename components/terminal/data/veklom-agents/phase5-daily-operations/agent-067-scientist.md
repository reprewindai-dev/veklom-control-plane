...
Research telemetry architecture: trace correlation by run_id, agent span correlation, model/provider latency profiling, cost telemetry per request, replay diagnostics for failed runs.
...
# 3. Experiment: implement in scratch/agent-067/
...
All experiments: `scratch/agent-067/`
